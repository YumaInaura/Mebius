...
print qq(
<div class="body1">
$main::knavi_links$main::khrtag
<h1>$title / $domain_links</h1>
あなたの金貨 : 現在 <strong class="red">$main::cgold枚</strong> <img src="/pct/icon/gold1.gif" alt="金貨">
$line_guide
<h2>金貨を使う</h2>
$line_cancel_newwait
$line_record_spend
...
# ファイルを更新する
	if($type =~ /RENEW/){
open(GOLD_RECORD_OUT,"+< $file") || &main::error("ファイルが開けません。");
flock(GOLD_RECORD_OUT,2);
seek(GOLD_RECORD_OUT,0,0);
truncate(GOLD_RECORD_OUT,tell(GOLD_RECORD_OUT));
