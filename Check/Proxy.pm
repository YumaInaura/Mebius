...
my $url = "https://www.cman.jp/network/support/go_access.cgi";
...
my $self = shift;
my $data_group = $self->fetchrow_main_table_asc({ deleted_flag => 0 , failed_count => ["<=",5] , country => ["IN",["JP","US","KR","FR","SG"]] , speed => ["<=",1000] },"speed",{ LIMIT => 100 });
